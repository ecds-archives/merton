# Django settings for merton project.
import os
from os import path
...
ROOT_URLCONF = 'merton.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'merton.wsgi.application'
...
try:
    ...
    import sys
    print >>sys.stderr, 'No local settings. Trying to start but if stuff blows up, try copying localsettings-sample.py to localsettings.py and setting appropriately for your environment.'
    pass
'''
